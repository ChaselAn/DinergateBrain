...
public struct ThreadStackBacktrace {
    public var all: String
    public var main: String
}

final class StackBacktrace: NSObject {
    
    static var value: ThreadStackBacktrace {
        return ThreadStackBacktrace(all: allThread(), main: mainThread())
    }
